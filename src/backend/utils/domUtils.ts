...
/**
 * Updates the CSS classes for a specific folder in the file explorer.
 */
...
/**
 * Updates the CSS classes for a folder note file in the file explorer and then also updates the folder it belongs to.
 */
