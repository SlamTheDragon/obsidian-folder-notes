...
import { createFolderNote } from '../../backend/core/FolderNoteService';
import { getFolderNote } from '../../backend/core/FolderNoteResolver';
import { getTemplatePlugins } from '../../backend/core/TemplateService';
import { getExcludedFolder } from '../../backend/core/ExcludeService';

export class CreateFnForEveryFolderModal extends Modal {
...
export default CreateFnForEveryFolderModal;
